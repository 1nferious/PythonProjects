...
token = "mfa.pCq3WIaWYspimurTyIMeyt-uoCt2IMLINHHAqKe2mIwv_NFJFq-c2_GOvlLXQctVxZglvE77ynz02k0vnApn" # Instructions on how to get this in README.md
...
print("Attempting to login to Discord account...\n")
